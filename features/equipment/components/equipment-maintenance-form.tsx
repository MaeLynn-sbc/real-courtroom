...
import { logEquipmentMaintenanceAction } from "@/actions/equipment.actions";
...
import { logMaintenanceSchema } from "@/features/equipment/schemas/equipment.schema";
...
export function EquipmentMaintenanceForm({ equipmentId }: { equipmentId: string }) {
  ...
  const onSubmit = handleSubmit((values) => {
    ...
    startTransition(async () => {
      const result = await logEquipmentMaintenanceAction(equipmentId, parsed.data);
      if (result.error) {
