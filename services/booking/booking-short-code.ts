// Short booking code (2026-08-06, shortened to 5 chars same day per
// owner feedback — "still so long" at 6): a code shown to customers
...
// generating a fresh code every attempt. At 31^5 (~28.6 million)
