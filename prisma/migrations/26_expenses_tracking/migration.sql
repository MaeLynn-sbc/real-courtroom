...
--
-- RENUMBERED at merge time: this branch was cut from main at migration
-- 24 (shift cash reconciliation), same as feature/gcash-reconciliation-
-- gate1, which independently claimed migration 25 for itself. GCash
-- merged to main first, so this migration was renumbered 25 -> 26 on
-- merge (same "renumber on conflict" precedent already used once this
-- project — the coaching merge's migration 18 -> 20). Folder renamed,
-- no content changes.
